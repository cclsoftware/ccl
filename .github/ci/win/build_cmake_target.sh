...
echo "cmake -B \"${builddir}\" --fresh --preset ${CMAKE_PRESET} -DVENDOR_CACHE_DIRECTORY=/c/w/.cache/ccl ${CMAKE_BUILD_OPTIONS}"
cmake -B "${builddir}" --fresh --preset ${CMAKE_PRESET} -DVENDOR_CACHE_DIRECTORY=/c/w/.cache/ccl ${CMAKE_BUILD_OPTIONS}
